...
#define GRAVITY_TOP    ((GRAVITY_AXIS_PULL_BEFORE | GRAVITY_AXIS_SPECIFIED) << GRAVITY_AXIS_Y_SHIFT)
/** Push object to the bottom of its container, not changing its size **/
#define GRAVITY_BOTTOM ((GRAVITY_AXIS_PULL_AFTER  | GRAVITY_AXIS_SPECIFIED) << GRAVITY_AXIS_Y_SHIFT)

/** Push object to the left of its container, not changing its size **/
#define GRAVITY_LEFT  ((GRAVITY_AXIS_PULL_BEFORE | GRAVITY_AXIS_SPECIFIED) << GRAVITY_AXIS_X_SHIFT)
/** Push object to the right of its container, not changing its size **/
#define GRAVITY_RIGHT ((GRAVITY_AXIS_PULL_AFTER  | GRAVITY_AXIS_SPECIFIED) << GRAVITY_AXIS_X_SHIFT)

/** Place object in the vertical center of its container, not changing its size **/
#define GRAVITY_CENTER_VERTICAL   (GRAVITY_AXIS_SPECIFIED << GRAVITY_AXIS_Y_SHIFT)
/** Place object in the horizontal center of its container, not changing its size **/
#define GRAVITY_CENTER_HORIZONTAL (GRAVITY_AXIS_SPECIFIED << GRAVITY_AXIS_X_SHIFT)
...
/** Raw bit controlling whether the layout direction is relative or not (START/END instead of LEFT/RIGHT) **/
#define GRAVITY_RELATIVE_LAYOUT_DIRECTION 0x00800000

/** Binary mask to get the absolute horizontal gravity of a gravity **/
#define GRAVITY_HORIZONTAL_MASK ((GRAVITY_AXIS_SPECIFIED | GRAVITY_AXIS_PULL_BEFORE | GRAVITY_AXIS_PULL_AFTER) << GRAVITY_AXIS_X_SHIFT)
/** Binary mask to get the vertical gravity of a gravity **/
#define GRAVITY_VERTICAL_MASK   ((GRAVITY_AXIS_SPECIFIED | GRAVITY_AXIS_PULL_BEFORE | GRAVITY_AXIS_PULL_AFTER) << GRAVITY_AXIS_Y_SHIFT)
